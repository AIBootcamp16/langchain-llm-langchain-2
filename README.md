...
- **데이터**: 데이터는 AIHUB의 인공지능 연구목적으로 가공된 형사법 자료를 재가공해 사용했습니다. 용량문제로 이 깃헙에는 업로드 되지 않습니다.
...
- 본 프로젝트는 법률 비전문가 출신의 비전문가 개발자들이 RAG 개발 학습용으로 만든 프로젝트입니다.
- 본 시스템의 답변은 **참고용 정보**이며, 법적 효력이 없습니다.
- AI가 생성한 답변에는 오류나 부정확한 정보가 포함될 수 있습니다.
- 실제 법률 문제에 대해서는 반드시 **법률 전문가**와 상담하시기 바랍니다.
- 본 시스템 사용으로 인한 어떠한 손해에 대해서도 개발자 전원은 책임지지 않습니다.
